			...
			<tbody>
				...
				<c:forEach items="${tb_odinfoxm.list }" var="list" varStatus="loop">
					...
					<tr>
						...
						<td class="td_num"><fmt:formatNumber value="${(list.ORDER_QTY * list.REAL_PRICE)-boxsaleval }" /> 원</td>
					</tr>
	...
	<div class="company mb_30">
		...
		<table class="table table-intro">
			<tbody>
				...
				<c:if test="${tb_odinfoxm.ORDER_CON ne 'ORDER_CON_04'}">
				<tr class="tb_line">
				</c:if>
...
<div class="btn_confirm">
	...
	<c:if test="${tb_odinfoxm.ORDER_CON eq 'ORDER_CON_01'}">
		<a onclick="javascript:;" id="btnAuth"  class="btn btn-sm btn-success pull-right" style="margin-right:5px;height:48px;padding-top: 14px;">신용카드</a>
	...
	<a type="button" class="btn btn-sm btn-default pull-right"onclick="fn_inst_bskt();" style="margin-right:5px;height:48px;">장바구니에 저장하고</br>상품추가 주문하기</a>
</div>

<div>	
	<img style="margin-left:40px;"src="${contextpath }/resources/images/mall/deleveryinfo.png">
...
<div class="modal fade" id="divPayModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"><!-- myModalLabel"> -->
	<div class="modal-dialog modal-lg" role="document" style="width: 680px;height: 650px;">
		<div class="modal-content">
			...
			<div class="modal-body" style="background-color: #ECF0F5;">
				...
				<iframe id="ifrmPayModal" src="" style="border:0; width:650px; height:650px;"> </iframe>
...
<div class="modal fade" id="fnPayCall2OkDiv" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
            <form role="form">            	
            	<img src="${contextPath}/resources/img/order/bank_info2.jpg" style="width:100%;height:auto;">
            </form>
			</div>
			<div class="modal-footer">
...
function cancel_popup(){
	if($("#payType").val()=='계좌이체'){
		window.open("${contextPath }/order/cancel/popup2?ORDER_NUM=${tb_odinfoxm.ORDER_NUM}&PAY_MDKY=${tb_odinfoxm.PAY_MDKY}", "_blank", "width=500, height=230");
	}else{
