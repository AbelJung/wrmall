...
<section class="content">
	<!-- Horizontal Form -->
				...
				<div class="box-body">
					<div class="form-group">
						...
						<c:if test="${tb_odinfoxm.ORDER_CON eq 'ORDER_CON_04'}">
							<label for="inputEmail3" class="col-sm-2 control-label">취소사유</label>
							<div class="col-sm-2">
								<p>${tb_odinfoxm.CNCL_MSG }</p>
							</div>
						</c:if>
					</div><br/>
					<div class="form-group">
			...
			<div class="box-footer" >
				<a href="${contextPath}/adm/orderCnclMgr" class="btn btn-default pull-right">리스트</a>
