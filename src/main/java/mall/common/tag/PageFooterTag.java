...
public class PageFooterTag extends BodyTagSupport
{
    ...
    public PageFooterTag()
    {
    	rowCount = 10;
        footNo = 10;
        firstBtn = "/resources/images/admin/common/btn_first.gif";
        prevBtn = "/resources/images/admin/common/btn_prev.gif";
        nextBtn = "/resources/images/admin/common/btn_next.gif";
        lastBtn = "/resources/images/admin/common/btn_end.gif";
        ...
        throws JspException
    {
        try
        {
            ...
            bodyText = "<div class='text-center'><ul class='pagination pagination-sm'>" + bodyText;
            bodyText = bodyText + "</ul></div>";
        ...
        throws Exception
    {
        ...
        if(gTotalPage != 0)
        {
            sb.append("<li><a href=\"" + url + "?pageNum=1&rowCnt=").append(rowCount).append(gSearchStr).append("\" >&laquo;</a></li>");
        }
        return sb.toString();
    }
        ...
        throws Exception
    {
        ...
        {
            StringBuffer sb = new StringBuffer(1024);
            sb.append("<li><a class=\"prev\" href=\"" + url + "?");
            
            // 이전 버튼 클릭시 마지막 페이지로 이동
            sb.append("pageNum=").append(pageNum % footNo != 0 ? pageNum - (pageNum % footNo) : pageNum - footNo).append("&rowCnt=").append(rowCount).append(gSearchStr).append("\">");
            sb.append("&lt;");
            sb.append("</a></li>");
            return sb.toString();
        } else
        ...
        throws Exception
    {
        ...
        for(int i = start; i <= end; i++)
        {
            ...
            if(pageNum == i)
            {
                sb.append("<li class=\"active\"><a>").append(pageNum).append("</a></li>");
            } else{
        ...
        throws Exception
    {
        ...
        if(pageNum <= gTotalPage)
        {
            ...
            sb.append("<li><a class=\"next\" href=\"" + url + "?");
            
            sb.append("pageNum=").append(pageNum).append("&rowCnt=").append(rowCount).append(gSearchStr).append("\">");
