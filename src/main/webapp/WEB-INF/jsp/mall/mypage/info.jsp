			        ...
			        <table class="table table-intro">
				        ...
				        <tr>
				            ...
				            <td>
								...
								<!-- <label class="radio-inline">
									<input type="radio" name="MEMB_GUBN" value="MEMB_GUBN_04" required ${ obj.MEMB_GUBN == 'MEMB_GUBN_04' ? 'checked' : '' } onclick="fn_memb_gbn()">도매유통사업자	
								</label>
				        ...
				        <tr>
				            ...
				            <td>
								...
								<div class="form-inline">
				                  ...
				                  <div style="float:right; cursor:pointer; background-color:yellow; border: 1px solid rgb(221, 221, 221);padding: 4px;border-radius: 4px;">                  	
				                  	세종특별시배송가능
				                  </div>
				                  <div class="thumbnail" style="float:right; cursor:pointer;">                  	
				                  	<p onclick="window.open('${contextPath }/resources/images/mall/dlvylocation_190515.jpg','배송가능지역','width=738, height=417 ,location=no,status=no,scrollbars=yes');">배송가능지역 확인</p>
