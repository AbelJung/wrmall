...
<section class="content">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<select name="ORDER_CON" class="form-control select2" style="width: 100%;">
								...
								<option value="ORDER_CON_03" ${obj.ORDER_CON == 'ORDER_CON_03' ? 'selected=selected':''}>배송준비중1</option>
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<button type="button" class="btn btn-primary btn-sm" onclick="javascript:fn_order_by('DLAR_DATE_ORDER');">오전/오후▼▲</button>
						</div>
	...
	<div class="row" style="padding-bottom:10px;">
		<div class="col-xs-12">
			...
			<button type="button" class="btn btn-warning btn-sm pull-right" onclick="javascript:fn_state('ORDER_CON_03');" style="margin-left: 5px" >배송준비중1</button>			
			<button type="button" class="btn btn-warning btn-sm pull-right" onclick="javascript:fn_state('ORDER_CON_08');" >구매완료</button>
		</div>
	</div>
			...
			<table class="table table-bordered">
				...
				<c:forEach items="${obj.list }" var="list" varStatus="loop">
					...
					<tr>
						...
						<td style="text-align: center;vertical-align : middle;">
							<a href="${contextPath}/adm/orderMgr/form/${list.ORDER_NUM }">상세</a>
						</td>
					</tr>
				</c:forEach>
				</tbody>
...
function delivery_slip(){
	...
	window.open('http://121.183.206.41/woori/Clickonce/cjflsRpt.application?'
			+'qr='+checkboxValues+'');
}
