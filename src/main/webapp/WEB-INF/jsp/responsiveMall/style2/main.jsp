...
$(document).ready(function(){
	...
	if(window.location == 'http://www.woorimarket.co.kr/m'){
		window.location.href='https://www.woorimarket.co.kr/m';
	}
	if(window.location == 'http://woorimarket.co.kr/m'){
		window.location.href='https://www.woorimarket.co.kr/m';
	}
    ...
    $(".btnTab2").click(function() {
        ...
        //탭 타이틀
        $("#tabTitle2").text($(this).text());
        
        //탭 메뉴 컨트롤
        $(".btnTab2").css("font-weight", "");
        $(".btnTab2").css("color", "#000");
        $(this).css("font-weight", "bold");
        $(this).css("color", "#246bc0");
    ...
    <div id="content">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 col2">
                        <div class="module sohomepage-slider ">
                            <div class="yt-content-slider"  data-rtl="yes" data-autoplay="yes" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column00="1" data-items_column0="1" data-items_column1="1" data-items_column2="1"  data-items_column3="1" data-items_column4="1" data-arrows="no" data-pagination="yes" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
                                ...
                                <c:if test="${obj.count == 0}">
	                                <div class="yt-content-slide">
	                                    <a href="#"><img src="${contextPath }/resources/img/main/main_slide2_190816.png" alt="slider1" class="img-responsive"></a>
	                                </div>
                                </c:if>
                            </div>                            
                        </div>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div id="mainProdList" class="so-category-slider container-slider module cate-slider2">
				<div class="modcontent">
					<div class="page-top">
						<div class="page-title-categoryslider" id="tabTitle">
							추천상품
						</div>
						<div class="item-sub-cat">
							<ul>
								<li><a class="btnTab" tab="tabRecommend" title="추가할인상품" style="font-weight:bold;color:#246bc0;">추천상품</a></li>
				...
				<div class="categoryslider-content show preset01-4 preset02-4 preset03-3 preset04-2 preset05-1">
					...
					<div
						...
						data-rtl="no" data-autoplay="yes" data-autoheight="no"
						data-delay="4" data-speed="0.6" data-margin="30"
						data-items_column00="6" data-items_column0="6" data-items_column1="6" 
						data-items_column2="4" data-items_column3="3" data-items_column4="2" 
			...
			<!-- 중식/일식 재료/제과점 재료/신상품 입점 -->
			<div id="mainProdList2" class="so-category-slider container-slider module cate-slider2">
				<div class="modcontent">
					<div class="page-top">
						<div class="page-title-categoryslider" id="tabTitle2">
							중식/일식 재료
						</div>
						<div class="item-sub-cat">
							<ul>
								<li><a class="btnTab2" tab="tabChineseJapanese" title="중식/일식 재료" style="font-weight:bold;color:#246bc0;">중식/일식 재료</a></li>
								<li><a class="btnTab2" tab="tabBakery" title="제과점 재료">제과점 재료</a></li>
								<li><a class="btnTab2" tab="tabNewProd" title="신상품 입점">신상품 입점</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="categoryslider-content show preset01-4 preset02-4 preset03-3 preset04-2 preset05-1">
					...
					<!-- 중식/일식 재료 시작 -->
					<div
						class="slider category-slider-inner products-list yt-content-slider divTab2" id="tabChineseJapanese"
						data-rtl="yes" data-autoplay="yes" data-autoheight="no"
						data-delay="4" data-speed="0.6" data-margin="30"
						data-items_column00="6" data-items_column0="6"
						data-items_column1="6" data-items_column2="4"
					...
					<!-- 제과점 재료 시작 -->
					<div
						class="slider category-slider-inner products-list yt-content-slider divTab2" id="tabBakery" style="display: none;"
						data-rtl="yes" data-autoplay="yes" data-autoheight="no"
						data-delay="4" data-speed="0.6" data-margin="30"
						data-items_column00="6" data-items_column0="6"
						data-items_column1="6" data-items_column2="4"
					...
					<!-- 신상품 입점 시작 -->
					<div
						class="slider category-slider-inner products-list yt-content-slider divTab2" id="tabNewProd" style="display: none;"
						data-rtl="yes" data-autoplay="yes" data-autoheight="no"
						data-delay="4" data-speed="0.6" data-margin="30"
						data-items_column00="6" data-items_column0="6"
						data-items_column1="6" data-items_column2="4"
