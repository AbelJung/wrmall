...
<form name="updateQtyFrm" id="updateQtyFrm" method="post" action="${contextPath }/adm/orderDltMgr/orderQtyUpdate" >
...
$("#btnExcel").click(function() {
	...
	form.method = "get";
	form.action = "${contextPath }/adm/orderDltMgr/detailExcelDown";
