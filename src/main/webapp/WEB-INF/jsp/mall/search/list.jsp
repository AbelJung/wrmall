							...
							<div style="position: absolute; width:161px; height:120px;">
								<c:if test="${ !empty(ent.ATFL_ID) }">
									...
									<c:if test="${ent.FILEPATH_FLAG ne 'woori' }">
										...
										<img class="goodsImg" src="C:/apache-tomcat-8.0.53/wtpwebapps/fmall/upload/${ent.STFL_PATH }/${ent.STFL_NAME }" alt="<c:out value="${ ent.PD_NAME }" escapeXml="true"/>"/>
									</c:if>
