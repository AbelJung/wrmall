...
<head>
    ...
    <style type="text/css">
         /* body{font-family:'Nanum Barun Gothic', 'Poppins', sans-serif} */
    </style>
...
<body class="common-home res layout-2" oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
