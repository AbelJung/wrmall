					...
					<div class="col-md-12 row-md-12">
						...
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab_1" data-toggle="tab"><b>광고 앞면</b></a></li>
								<li><a href="#tab_2" data-toggle="tab"><b>광고 뒷면</b></a></li>
							</ul>
							<div class="tab-content">
								<c:if test="${obj.count > 0}">
									<div class="tab-pane active" id="tab_1">
										<img src="${contextPath }/upload/${obj.JD_PATH}${obj.JD_FL1 }" class="imgHelp" />
									</div>
									<div class="tab-pane" id="tab_2">
										<img src="${contextPath }/upload/${obj.JD_PATH}${obj.JD_FL2 }" class="imgHelp" />
									</div>
								</c:if>
								<c:if test="${obj.count == 0}">
									<div class="tab-pane active" id="tab_1">
										<img src="" class="imgHelp" />
									</div>
									<div class="tab-pane" id="tab_2">
										<img src="" class="imgHelp" />
									</div>
