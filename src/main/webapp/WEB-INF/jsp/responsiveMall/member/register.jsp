	...
	<div class="main-container container">
		...
		<div class="row">
			<div id="content" class="col-sm-12">
			    ...
			    <form id="fregisterform" name="fregisterform" class="form-horizontal account-register clearfix" action="${contextPath }/m/memberInsert" onsubmit="return fregisterform_submit(this);" method="post" autocomplete="off">
				...
				<input type="hidden" name="BANK_BUNB" value="${obj.BANK_BUNB }" id="BANK_BUNB">
					<fieldset id="account">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="MEMB_ID" placeholder="영문자로 시작하는 5~16자의 숫자와 영문자 조합" value="" id="MEMB_ID" required class="form-control" minlength="3" maxlength="20" onblur="javascript:fn_idChk();">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="password" name="MEMB_PW" placeholder="숫자와 영문자 조합으로 5~12자리" value="" id="MEMB_PW" class="form-control" required onblur="javascript:fnCheckPassword($('#MEMB_ID').val(),$('#MEMB_PW').val());">
							</div>
						</div>
						<div class="form-group required">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="MEMB_NAME" value="" placeholder="이름 (대표자성명)" id="MEMB_NAME" class="form-control" required>
							</div>
						</div>
						<div class="form-group required">
							...
							<div class="col-sm-10">
								...
								<div class="form-inline">
									<div class="input-group">
										<input type="text" name="MEMB_PN" value="" id="MEMB_PN" placeholder="우편번호" required readonly="readonly" class="form-control" maxlength="6">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="MEMB_BADR" value="" id="MEMB_BADR" placeholder="기본주소" required readonly="readonly" class="form-control">
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="MEMB_DADR">상세주소</label>
							<div class="col-sm-10">
								<input type="text" name="MEMB_DADR" value="" id="MEMB_DADR" placeholder="상세주소" required class="form-control">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<input type="text" name="MEMB_TELN1" value="" id="MEMB_TELN1" class="form-control"  style="width:60px; display: inline-block;" maxlength="3" onkeydown="return onlyNumber(this)">&nbsp;-&nbsp;
									<input type="text" name="MEMB_TELN2" value="" id="MEMB_TELN2" class="form-control"  style="width:60px; display: inline-block;" maxlength="4" onkeydown="return onlyNumber(this)">&nbsp;-&nbsp;
									<input type="text" name="MEMB_TELN3" value="" id="MEMB_TELN3" class="form-control"  style="width:60px; display: inline-block;" maxlength="4" onkeydown="return onlyNumber(this)">
								</div>
							</div>
						</div>
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<input type="text" name="MEMB_CPON1" value="" id="MEMB_CPON1" required class="form-control"  style="width:60px; display: inline-block;" maxlength="3" onkeydown="return onlyNumber(this)">&nbsp;-&nbsp;
									<input type="text" name="MEMB_CPON2" value="" id="MEMB_CPON2" required class="form-control"  style="width:60px; display: inline-block;" maxlength="4" onkeydown="return onlyNumber(this)">&nbsp;-&nbsp;
									<input type="text" name="MEMB_CPON3" value="" id="MEMB_CPON3" required class="form-control"  style="width:60px; display: inline-block;" maxlength="4" onkeydown="return onlyNumber(this)">
								</div>
							</div>
						</div>
					</fieldset>
					<fieldset id="ERP_LIST">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="COM_NAME" value="" placeholder="상호명" id="COM_NAME" class="form-control">
							</div>
						</div>
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="COM_BUNB">사업자등록번호</label>
							<div class="col-sm-10">
								<input type="text" name="COM_BUNB" value="" placeholder="-를 제외하고 적어주세요" id="COM_BUNB" class="form-control" onblur="javascript:fn_bunbChk();" onkeydown="return onlyNumber(this)" maxlength="10">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="form-inline">
									...
									<input type="text" name="COM_TELN1" value="" id="COM_TELN1" class="form-control"  style="width:60px; display: inline-block;" maxlength="3" onkeydown="return onlyNumber(this)">&nbsp;-&nbsp;
									<input type="text" name="COM_TELN2" value="" id="COM_TELN2" class="form-control"  style="width:60px; display: inline-block;" maxlength="4" onkeydown="return onlyNumber(this)">&nbsp;-&nbsp;
									<input type="text" name="COM_TELN3" value="" id="COM_TELN3" class="form-control"  style="width:60px; display: inline-block;" maxlength="4" onkeydown="return onlyNumber(this)">
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="COM_BADR" value="" id="COM_BADR" placeholder="회사 기본주소" readonly="readonly" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="COM_DADR">회사 상세주소</label>
							<div class="col-sm-10">
								<input type="text" name="COM_DADR" value="" id="COM_DADR" placeholder="회사 상세주소" class="form-control">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="KEEP_LOCATION" value="" placeholder="상품보관장소" id="KEEP_LOCATION" class="form-control">
					...
					<div class="buttons">
						<div class="pull-right">나는 <a class="agree viewPopup"><b>회원가입약관 및 개인정보처리방침안내</b></a>를 읽었으면 동의합니다. 
							<input class="box-checkbox" type="checkbox" id="agree" name="agree" value="1"> &nbsp;
							<input type="submit" id="btn_submit" value="회원가입" class="btn btn-primary"> &nbsp;
	            ...
	            <!-- 기업정보 박스 -->
	               <div class="box box-info">
	                  <div class="box-body">
						...
						<div class="form-group">
							<label for="TERM_CONT1" class="control-label">회원가입약관</label>
			        		<textarea rows="10" class="form-control" id="TERM_CONT1" readonly>${TERM[0].TERM_CONT }</textarea>
						</div>
						
						<div class="form-group">
							<label for="TERM_CONT2" class="control-label">개인정보처리방침안내</label>
			        		<textarea rows="10" class="form-control" id="TERM_CONT2" readonly>${TERM[1].TERM_CONT }</textarea>
						</div>
